...
assert(html.includes('game-v6.js'), 'index.html deve carregar game-v6.js');
...
for (const p of data.players) {
  assert(p[0] && p[1] && Array.isArray(p[4]), `craque inválido: ${p[0]}`);
